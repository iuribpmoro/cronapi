...
async function migrate(): Promise<void> {
  ...
  try {
    ...
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS alert_80_sent_month TEXT`);
    await client.query(`ALTER TABLE users ADD COLUMN IF NOT EXISTS alert_100_sent_month TEXT`);
